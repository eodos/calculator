...
!(function(a, b) {
	...
	(r.fn = r.prototype = {
		...
		makeArray: function(a, b) {
			var c = b || [];
			return null != a &&
				(w(Object(a)) ? r.merge(c, 'string' == typeof a ? [a] : a) : h.call(c, a)), c;
		},
	...
	var x = (function(a) {
		...
		(ra.prototype = d.filters =
			...
			while (h) {
				(c && !(e = Q.exec(h))) ||
					(e && (h = h.slice(e[0].length) || h), i.push((f = []))), (c = !1), (e = R.exec(
					h
				)) &&
					(
						(c = e.shift()),
		...
		function xa(a, b, c, d, e, f) {
			return d && !d[u] && (d = xa(d)), e && !e[u] && (e = xa(e, f)), ia(function(
				...
				if (f) {
					...
					(r = wa(r === g ? r.splice(o, r.length) : r)), e
						? e(null, g, r, i)
						: G.apply(g, r);
			});
		}
										...
										: function() {
												try {
													...
													r.Deferred.exceptionHook &&
														r.Deferred.exceptionHook(a, k.stackTrace), b +
														1 >=
														f &&
														(
															d !== N && ((h = void 0), (i = [a])),
		...
		remove: function(a, b) {
			...
			if (void 0 !== d) {
				if (void 0 !== b) {
					r.isArray(b)
						? (b = b.map(r.camelCase))
						: ((b = r.camelCase(b)), (b = b in d ? [b] : b.match(K) || [])), (c =
						b.length);
	...
	function Z(a) {
		return (
			'true' === a ||
			('false' !== a &&
				('null' === a ? null : a === +a + '' ? +a : X.test(a) ? JSON.parse(a) : a))
		);
	}
	function $(a, b, c) {
		var d;
	...
	r.extend({
		...
		dequeue: function(a, b) {
			...
			'inprogress' === e && ((e = c.shift()), d--), e &&
				('fx' === b && c.unshift('inprogress'), delete f.stop, e.call(a, g, f)), !d &&
				f &&
				f.empty.fire();
		},
			...
			if (((f = a[n]), f || 0 === f))
				if ('object' === r.type(f)) r.merge(m, f.nodeType ? [f] : f);
					...
					(g = g || l.appendChild(b.createElement('div'))), (h = (ja.exec(f) || [
						...
						.toLowerCase()), (i = la[h] || la._default), (g.innerHTML =
		...
		add: function(a, b, c, d, e) {
			...
			if (q) {
				c.handler && ((f = c), (c = f.handler), (e = f.selector)), e &&
					r.find.matchesSelector(qa, e), c.guid || (c.guid = r.guid++), (i = q.events) ||
	...
	function Ia(a, b, c, d) {
		...
		if (
			...
			for (h = r.map(ma(e, 'script'), Ea), i = h.length; l < m; l++)
				(j = e), l !== n &&
					((j = r.clone(j, !0, !0)), i && r.merge(h, ma(j, 'script'))), c.call(
					a[l],
					j,
					l
				);
	...
	function Ja(a, b, c) {
		for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
			c || 1 !== d.nodeType || r.cleanData(ma(d)), d.parentNode &&
				(
	...
	function Wa(a, b, c, d, e) {
		...
		for (f = c === (d ? 'border' : 'content') ? 4 : 'width' === b ? 1 : 0; f < 4; f += 2)
			'margin' === c && (g += r.css(a, c + ba[f], !0, e)), d
				? (
	...
	r.extend({
		...
		css: function(a, b, c, d) {
			...
			return (b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h)), (g =
				...
				'get' in g &&
				(e = g.get(a, !0, c)), void 0 === e && (e = Na(a, b, d)), 'normal' === e &&
				b in Ra &&
				(e = Ra[b]), '' === c || c
	...
	r.fn.extend({
		...
		Za[b] = function(a, b, d) {
			var e,
				...
				g = b.toLowerCase();
			return d ||
				((f = Za[g]), (Za[g] = e), (e = null != c(a, b, d) ? g : null), (Za[g] = f)), e;
		};
	});
		...
		propHooks: {
			tabIndex: {
				get: function(a) {
					...
					return b
						? parseInt(b, 10)
						: $a.test(a.nodeName) || (_a.test(a.nodeName) && a.href) ? 0 : -1;
				}
			}
		},
	...
	r.fn.extend({
		val: function(a) {
				...
				e = this[0];
			{
				...
				if (e)
					return (b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()]), b &&
					'get' in b &&
			...
			select: {
				...
				set: function(a, b) {
					var c,
						...
						g = e.length;
					while (g--)
						(d = e[g]), (d.selected = r.inArray(r.valHooks.option.get(d), f) > -1) &&
							(c = !0);
			...
			if (
				...
				while ((h = o[g++]) && !b.isPropagationStopped())
					(b.type = g > 1 ? j : n.bindType || p), (m =
						(V.get(h, 'events') || {})[b.type] && V.get(h, 'handle')), m &&
	...
	function ib(a, b, c, d) {
		...
		if (r.isArray(b))
			r.each(b, function(b, e) {
				c || eb.test(a)
					? d(a, e)
					: ib(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e, c, d);
			});
	...
	(r.offset = {
		setOffset: function(a, b, c) {
			var d,
				...
				l = r(a),
				m = {};
			'static' === k && (a.style.position = 'relative'), (h = l.offset()), (f = r.css(
				a,
				'top'
			)), (i = r.css(a, 'left')), (j =
