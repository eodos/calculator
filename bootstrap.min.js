...
+(function(t) {
		...
		s = (
				...
				var e = 'alert',
					...
					_ = (function() {
						...
						return (e.prototype.close = function(t) {
							...
							var n = this;
							return t(e).removeClass(f.SHOW), r.supportsTransitionEnd() &&
							t(e).hasClass(f.FADE)
								? void t(e)
			...
			(function(t) {
				...
				return t(document)
					...
					}), (t.fn[e] = d._jQueryInterface), (t.fn[e].Constructor = d), (t.fn[
					e
				].noConflict = function() {
			...
			(function(t) {
				var e = 'carousel',
					...
					T = (function() {
						...
						return (h.prototype.next = function() {
							...
							t(this._element).off(l), t.removeData(
								this._element,
								a
							...
							if (!d.isDefaultPrevented() && o && s) {
								(this._isSliding = !0), a &&
									this.pause(), this._setActiveIndicatorElement(s);
											...
											t(o)
												.one(r.TRANSITION_END, function() {
													t(s)
														...
														.addClass(
															E.ACTIVE
														), t(o).removeClass(E.ACTIVE + ' ' + h + ' ' + l), (i._isSliding = !1), setTimeout(function() {
				...
				return t(document).on(m.CLICK_DATA_API, v.DATA_SLIDE, T._dataApiClickHandler), t(
					window
				).on(m.LOAD_DATA_API, function() {
				...
				var e = 'collapse',
					...
					E = (function() {
						...
						return (l.prototype.toggle = function() {
									...
									if ((t(this._element).trigger(o), !o.isDefaultPrevented())) {
										...
										var h = function() {
											t(e._element)
												...
												.addClass(g.COLLAPSE)
												.addClass(g.SHOW), (e._element.style[s] =
										...
										t(this._element)
											...
											.emulateTransitionEnd(u), (this._element.style[s] =
											this._element[d] + 'px');
									}
								}
							}
							...
							return (n = t.extend({}, d, n)), (n.toggle = Boolean(
								n.toggle
							)), r.typeCheckConfig(e, n, f), n;
			...
			(function(t) {
				var e = 'dropdown',
					...
					m = (function() {
						...
						return (e.prototype.toggle = function() {
							...
							t.removeData(this._element, s), t(this._element).off(
								a
							), (this._element = null);
				...
				return t(document)
					...
					.on(_.CLICK_DATA_API, p.FORM_CHILD, function(t) {
						t.stopPropagation();
					}), (t.fn[e] = m._jQueryInterface), (t.fn[e].Constructor = m), (t.fn[
					e
				].noConflict = function() {
			...
			(function(t) {
				var e = 'modal',
					...
					v = (function() {
						function h(e, i) {
							n(this, h), (this._config = this._getConfig(
								i
						...
						return (h.prototype.toggle = function(t) {
							...
							t(this._element).trigger(i), this._isShown ||
								...
								(
									...
									t(this._element).on(p.CLICK_DISMISS, E.DATA_DISMISS, function(
										t
									) {
										return n.hide(t);
									}),
							...
							t(this._element).trigger(o), this._isShown &&
							...
							t.removeData(this._element, a), t(
								window,
								document,
								this._element,
								this._backdrop
							...
							(this._element.style.display = 'none'), this._element.setAttribute(
								...
								t(document.body).removeClass(
									m.OPEN
								), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(p.HIDDEN);
							});
							...
							(this._originalBodyPadding =
								document.body.style.paddingRight || ''), this._isBodyOverflowing &&
				...
				}), (t.fn[e] = v._jQueryInterface), (t.fn[e].Constructor = v), (t.fn[
					e
				].noConflict = function() {
			...
			(function(t) {
				var e = 'scrollspy',
					...
					m = (function() {
						function h(e, i) {
							var o = this;
							n(this, h), (this._element = e), (this._scrollElement =
								'BODY' === e.tagName ? window : e), (this._config = this._getConfig(
								i
							)), (this._selector =
								this._config.target +
								' ' +
						...
						return (h.prototype.refresh = function() {
							...
							s
								.map(function(e) {
									...
									return s &&
										(n = t(
											s
										)[0]), n && (n.offsetWidth || n.offsetHeight) ? [t(n)[i]().top + o, s] : null;
								})
								.filter(function(t) {
									return t;
								})
							...
							t.removeData(this._element, a), t(this._scrollElement).off(
								l
							...
							if (((n = t.extend({}, u, n)), 'string' != typeof n.target)) {
								...
								i || ((i = r.getUID(e)), t(n.target).attr('id', i)), (n.target =
									'#' + i);
							}
			...
			(function(t) {
					...
					I = (function() {
						function h(t, e) {
							n(
								...
								''), (this._activeTrigger = {}), (this._isTransitioning = !1), (this._tether = null), (this.element = t), (this.config = this._getConfig(
								e
						...
						return (h.prototype.enable = function() {
							...
							clearTimeout(this._timeout), this.cleanupTether(), t.removeData(
								this.element,
							...
							if (this.isWithContent() && this._isEnabled) {
								...
								t(o).data(this.constructor.DATA_KEY, this).appendTo(c), t(
									this.element
								).trigger(
								...
								var d = function() {
									var n = e._hoverState;
									(e._hoverState = null), (e._isTransitioning = !1), t(
										e.element
									).trigger(e.constructor.Event.SHOWN), n === g.OUT &&
										e._leave(null, e);
								};
								if (r.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE))
									return (this._isTransitioning = !0), void t(this.tip)
							...
							if (
								...
								return clearTimeout(n._timeout), (n._hoverState = g.OUT), n.config
				...
				return (t.fn[e] = I._jQueryInterface), (t.fn[e].Constructor = I), (t.fn[
					e
				].noConflict = function() {
	...
	(function(r) {
			...
			m = (function(s) {
				...
				return e(u, s), (u.prototype.isWithContent = function() {
					...
					this.setElementContent(
						t.find(g.TITLE),
						this.getTitle()
					), this.setElementContent(t.find(g.CONTENT), this._getContent()), t.removeClass(
						_.FADE + ' ' + _.SHOW
					), this.cleanupTether();
		...
		return (r.fn[a] = m._jQueryInterface), (r.fn[a].Constructor = m), (r.fn[
			a
		].noConflict = function() {
